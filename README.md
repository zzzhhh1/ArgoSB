...
```ip=4 agsb list```或者```ip=4 bash <(curl -Ls https://raw.githubusercontent.com/zzzhhh1/argosb/main/argosbx.sh) list```

显示IPV6节点配置：

```ip=6 agsb list```或者```ip=6 bash <(curl -Ls https://raw.githubusercontent.com/zzzhhh1/argosb/main/argosbx.sh) list```
